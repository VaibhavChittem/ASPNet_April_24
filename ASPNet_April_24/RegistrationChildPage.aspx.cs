...
{
    public partial class RegistrationChildPage : System.Web.UI.Page
    {
        ...
        {
            if (txtFirstName.Text == null || txtEmailID.Text == null || txtPassword.Text == null || txtMobileNo.Text == null)
            {
                Response.Redirect("RegidtrationChildPage.aspx");
            }
            else
            {
